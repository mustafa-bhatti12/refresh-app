...
const styles = (colors: ColorRamp) =>
  StyleSheet.create({
    ...
    reviewMeta: { fontSize: 10, fontWeight: "700", color: colors.softZinc, marginTop: 1 },
    reactionPill: { backgroundColor: colors.surfaceZinc, borderRadius: 4, paddingHorizontal: 5, paddingVertical: 2 },
    reactionPillText: { fontSize: 9, fontWeight: "700", color: colors.midZinc },
    comments: { fontSize: 12, color: colors.slateZinc, backgroundColor: colors.surfaceZinc, borderRadius: 6, padding: 8, marginTop: 8 },
    brewedBy: { fontSize: 10, fontWeight: "600", color: colors.softZinc },
    timestamp: { fontSize: 9, color: colors.softZinc },
  });
